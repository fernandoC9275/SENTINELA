			...
			<table cellpadding='0' cellspacing='0' border='0' width='700px' align='center' style='width:700px;font-family: Verdana; font-size: 12px;line-height:160%'>
				...
				<tr style='background-color:#fab778;'>
					<td style='text-align:center;' colspan='10'>
						<h3>Devoluções não realizadas - Itens de cirurgias canceladas - ".$mes_atual."</h3>
					</td>
				...
				foreach ($dados as $value) {
					...
					$message .= "<tr>";
					$message .= "<td style='text-align:left;' colspan='3'><p>".$value['CD_AVISO_CIRURGIA']."</p></td>";
					$message .= "<td style='text-align:left;' colspan='3'><p>".$value['NM_PACIENTE']."</p></td>";
					$message .= "<td style='text-align:right;' colspan='3'><p>".$value['TOTAL_ITENS']."</p></td>";
					$message .= "</tr>";	
