			...
			<table cellpadding='0' cellspacing='0' border='0' width='700px' align='center' style='width:700px;font-family: Verdana; font-size: 12px;line-height:160%'>
				...
				<tr style='background-color:#fab778;'>
					<td style='text-align:center;' colspan='10'>
						<h3>À faturar / Não faturado - ".$mes_atual."</h3>
					</td>
				...
				foreach ($dados as $value) {
					...
					$message .= "<tr>";
					$message .= "<td colspan='3'><p>".$value['CONVENIO']."</p></td>";
					$message .= "<td style='text-align:right;' colspan='3'><p>".$value['QT_A_FATURAR']."</p></td>";
					$message .= "<td style='text-align:right;' colspan='3'><p>".$value['QT_N_FATURADO']."</p></td>";
					$message .= "</tr>";	
				...
				<tr>
					...
					<td style='text-align:right;' colspan='3'><h3>".$total_a_faturar."</h3></td>
					<td style='text-align:right;' colspan='3'><h3>".$total_n_faturado."</h3></td>
				</tr>
