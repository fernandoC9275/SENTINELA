		...
		<td>
			<table cellpadding='0' cellspacing='0' border='0' width='700px' align='center' style='width:700px;font-family: Verdana; font-size: 12px;line-height:160%'>
				...
				foreach ($dados as $value) {
					...
					$message .= "<tr>";
					$message .= "<td colspan='5'><p>".$value['NM_CONVENIO']."</p></td>";
					$message .= "<td style='text-align:right;' colspan='5'><p>".$value['SOMATORIO']."</p></td>";
					$message .= "</tr>";	
				};
				...
				<tr style='background-color:#fab778;'>
					<td style='text-align:center;' colspan='10'>
						<h3>Notas fiscais canceladas - ".$mes_atual."</h3>
					</td>
				...
				foreach ($dados_notas_canceladas as $value) {
				...
				<tr style='background-color:#fab778;'>
					<td style='text-align:center;' colspan='10'>
						<h3>Resumo mês anterior  -  ".$mes_anterior."</h3>
					</td>
				</tr>
				<tr>
					<td colspan='10' height='1' bgcolor='#cccccc' style='font-size: 1px; line-height: 1px;'>&nbsp;</td>
				...
				<tr>
					...
					<td colspan='5'>
						<h3>".$total_geral_mes_anterior."</h3> 
					</td>
					
					<td colspan='5' style='text-align:right;'>
						<h3>".$total_geral_canceladas_mes_anterior."</h3> 
					</td>
